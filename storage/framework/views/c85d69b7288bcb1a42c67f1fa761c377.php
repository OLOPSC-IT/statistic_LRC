  ...
  <body>
   ...
   <!-- footer begins -->
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy;  <?php echo e(now()->format('F j, Y')); ?>  <a href="/" class="text-muted"><b>OLOPSC LRC Attendance System</b></a>. All rights reserved.</p>
      </footer>
...
<?php /**PATH C:\Users\Fourth\Documents\fourth\stats\resources\views/components/header.blade.php ENDPATH**/ ?>