...
<html lang="en">
  ...
  <body>
    <header class="header-bar mb-3" style="background-color:#0a095f;">
      ...
      <div>
        <a href="/1" style="color: #ffd230" class="ml-3 mr-3"> ENTER STATISTICS </a>
      </div>
   ...
   <!-- footer begins -->
    <footer class="border-top text-center small text-muted py-3">
        <p class="m-0">Copyright &copy; <?php echo e(now()->format('Y')); ?> <a href="/" class="text-muted"><b>OLOPSC LRC Attendance System</b></a>. All rights reserved.</p>
      </footer>
  ...
  <?php /**PATH C:\Users\Fourth\Documents\fourth\stats\resources\views/components/layout.blade.php ENDPATH**/ ?>